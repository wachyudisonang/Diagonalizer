...
//                $comparison = $field['required'][1];
        ...
        public function _options_page_html() {
            ...
            // Header area
            echo '<div id="redux-header" style="background:#0074A2">';
                
            if( !empty( $this->args['display_name'] ) ) {
                echo '<div class="diagonal" style="color:#00ABEE;display:inline-block;float:right;margin:51px 20px 0 0;font-size:24px">DIAGONAL FRAMEWORK</div>';
                
                echo '<div class="display_header" style="display:table;">';
                // echo '<h2>' . $this->args['display_name'] . '</h2>';
                echo '<h2><img id="logo" alt="Diagonalizer Theme" src="' . get_template_directory_uri() . '/diagonalizer_logo_white.png"></h2>';

                if( !empty( $this->args['display_version'] ) )
                    echo '<span style="display:table-cell;vertical-align:middle;padding:15px 0 0 10px;">ver ' . $this->args['display_version'] . '</span>';
...
// echo Redux_Helpers::cleanFilePath( dirname( __FILE__ ) );
// echo ReduxFramework::$_url;