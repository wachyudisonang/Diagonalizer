...
function roots_theme_activation_options_add_page() {
  ...
  if (!$roots_activation_options) {
    ...
    if (is_admin() && isset($_GET['page']) && $_GET['page'] === 'theme_activation_options') {
      flush_rewrite_rules();
      // wp_redirect(admin_url('themes.php?page=optionsframework')); //SMOF
      wp_redirect(admin_url('admin.php?page=_options')); // REDUX
      exit;
    }
  }
}
        ...
        <tr valign="top"><th scope="row"><?php _e('Create static front page?', 'roots'); ?></th>
          <td>
            <fieldset>
              ...
              <p class="description"><?php printf(__('Create a page called "Welcome to Diagonalizer" and set it to be the static front page', 'roots')); ?></p>
            </fieldset>
          </td>
        </tr>
...
function roots_theme_activation_action() {
  ...
  if ($roots_theme_activation_options['create_front_page'] === 'true') {
    ...
    $default_pages = array('Welcome to Diagonalizer');
    ...
    $home = get_page_by_title('Welcome to Diagonalizer');
